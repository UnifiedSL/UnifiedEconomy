...
namespace UnifiedEconomy.Command.Admin
{
    ...
    public class EcoTakeCommand : ICommand
    {
        ...
        public string Permission { get; } = string.IsNullOrEmpty(UEMain.Singleton.Config.Economy.PermissionForAdminCommand) ? "" : UEMain.Singleton.Config.Economy.PermissionForAdminCommand + ".take";
